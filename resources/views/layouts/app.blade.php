...
/* End carousel */
  ...
  <!-- /Navigation-->
    ...
    <!-- jQuery Easing -->
    <script src="{{config('app.baseURL')}}/assets/js/jquery.easing.1.3.js"></script>
    <!-- Bootstrap -->
    <script src="{{config('app.baseURL')}}/assets/js/bootstrap.min.js"></script>
    <!-- Waypoints -->
    <script src="{{config('app.baseURL')}}/assets/js/jquery.waypoints.min.js"></script>
    <!-- Stellar Parallax -->
    <script src="{{config('app.baseURL')}}/assets/js/jquery.stellar.min.js"></script>
    <!-- Carousel -->
    <script src="{{config('app.baseURL')}}/assets/js/owl.carousel.min.js"></script>
    <!-- Flexslider -->
    <script src="{{config('app.baseURL')}}/assets/js/jquery.flexslider-min.js"></script>
    <!-- countTo -->
    <script src="{{config('app.baseURL')}}/assets/js/jquery.countTo.js"></script>
    <!-- Magnific Popup -->
    <script src="{{config('app.baseURL')}}/assets/js/jquery.magnific-popup.min.js"></script>
    <script src="{{config('app.baseURL')}}/assets/js/magnific-popup-options.js"></script>
    <!-- Count Down -->
    <script src="{{config('app.baseURL')}}/assets/js/simplyCountdown.js"></script>
    <!-- Main -->
