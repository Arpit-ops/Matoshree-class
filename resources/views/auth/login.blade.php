...
<body>
    <h2>Matoshree Classes</h2>
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form method="POST" action="{{config('app.baseURL')}}/signup">
	...
	<div class="form-container sign-in-container">
		<form method="POST" action="{{config('app.baseURL')}}/login">
			<h1>Sign in</h1>
			<span>use your account</span>
			<input type="text" placeholder="Phone Number" name="phone_number" id="phone_number" onkeypress="myFunction()" required />
			
			<input type="password" placeholder="OTP" id="otp" name="otp" required />
			<a id="otplink" href="#" style="color: rgb(255, 75, 43)">Send OTP</a>
			<a href="#">Forgot your Number?</a>
...
<script >
	$("#otplink").on("click", function(){
		...
		$.ajax({
			type: "POST",
			url: "{{config('app.baseURL')}}/sendOtp",
  ...
  <div id="container" class="cls-container">
            ...
            <div class="lock-wrapper">
                <div class="panel lock-box">
                    ...
                    <div class="row">
                        <form action="{{ route('login') }}" class="form-inline" method="post">
